                ...
                <div class="container-fluid">
                    <div class="mb-3">
                        <p>
                            <a class="btn btn-dark" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                                <i class="fas fa-plus-square"></i> Tambah Data Foto
                            </a>
                        </p>
                        <div class="collapse" id="collapseExample">
                            <div class="card card-body">
                                <form method="POST" action="" enctype="multipart/form-data">
                                    ...
                                    <button type="submit" name="submit" class="btn btn-dark w-100">Unggah</button>
                                </form>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-dark">Data Foto Anda</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($fotos as $data) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="btn btn-sm btn-dark" data-toggle="modal" data-target="#hapusModal<?= $data['FotoID'] ?>">Hapus</a>
                                                    </td>
                                                   <a href="#" class="btn btn-sm btn-dark" data-toggle="modal" data-target="#editModal<?= $data['FotoID'] ?>">Edit</a>
                                                  </td>
                                            </tr>

                                            <div class="modal fade" id="hapusModal<?= $data['FotoID'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal fade" id="editModal<?= $data['FotoID'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            Apakah anda ingin mengedit foto ini ?
                                                        </div>
                                                        <div class="modal-footer">
                                                            ...
                                                            <form action="" method="post">
                                                                ...
                                                                <input type="hidden" name="fotoID" value="<?= $data['FotoID'] ?>">
                                                                <button type="submit" name="edit" class="btn btn-dark w-100">Simpan</button>
                                                                <button type="submit" name="edit" class="btn btn-dark">Simpan</button>
                </button>
                                                            </fo  rm>
                                                        </div>
                                                    </div>
