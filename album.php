                ...
                <div class="container-fluid">
                    <div class="mb-3">
                        <p>
                            <a class="btn btn-dark" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                                <i class="fas fa-plus-square"></i> Tambah Data Album
                            </a>
                        </p>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-dark">Data Album</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($albums as $data) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="btn btn-sm btn-dark" data-toggle="modal" data-target="#editModal<?= $data['AlbumID'] ?>">Edit</a>
                                                    <a href="#" class="btn btn-sm btn-dark" data-toggle="modal" data-target="#hapusModal<?= $data['AlbumID'] ?>">Hapus</a>
                                                </td>
                                            </tr>
